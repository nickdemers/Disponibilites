...
describe Utilisateur do
  ...
  describe "Mise à jour" do
    ...
    it "en erreur, niveau doit être numérique" do
      user = Utilisateur.create({prenom: 'Nicolas', nom: 'Demers', courriel: 'nickdemers@gmail.com', message_texte_permis: 'non',
                                 niveau: 3, numero_cellulaire: '418 999-8888', numero_telephone: '418 777-5555', titre: 'Permanent'})
      user.niveau = 'test'
      user.should be_invalid
    end
